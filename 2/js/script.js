        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0 || storySlider.activeIndex === 1) {
              ...
              const currentSlide = storySlider.slides[storySlider.realIndex];

              document.querySelectorAll('.slider__item-text').forEach((el) => {
                el.classList.remove('active');
              });

              setTimeout(() => {
                currentSlide.querySelector('.slider__item-text').classList.add('active');
              }, 200);
        ...
        on: {
          slideChange: () => {
            if (storySlider.activeIndex === 0) {
              ...
              const currentSlide = storySlider.slides[storySlider.realIndex];
              const currentSlideNext = storySlider.slides[storySlider.realIndex + 1];
              ...
              setTimeout(() => {
                currentSlideNext.querySelector('.slider__item-text').classList.add('active');
              }, 600);
